...
while True:
    ...
    if pregunta_de_descuento.lower() == "si":
        ...
        print("=" * 60)
        print(" " * 60)
        #imprime el costo sin descuento y organiza a la izquiera y a la derecha el texto
        print(f"Producto: {nombre_del_producto}".ljust(30) + f"Costo total: ${costo_sin_descuento:.2f}".rjust(30))#se limita el costo a 2 decimales
